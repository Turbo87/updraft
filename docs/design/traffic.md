...
The table is published as keyed-collection changes (see [core.md](core.md)). Each target is a **kinematic state vector** — position, track, ground speed, turn rate, climb rate, and timestamp — not a bare coordinate.
