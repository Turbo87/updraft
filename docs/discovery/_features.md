...
- Raster / satellite / sectional-chart basemaps *(SeeYou Navigator, Navia, G3X, Enroute)*
...
- Map orientation (track / north / target up; plus variants: heading-up, goal-up, downwind-up, desired-track-up, separate circling orientation)
...
- Task sharing via QR code / NFC / email / messaging *(XCTrack, SeeYou Navigator QR)*
...
- Physiological sensors: heart rate, SpO₂ *(LXNAV navboxes, LK8000 HR ingest; G3X pulse-oximeter/CO integration)*
...
- FLARM traffic dead reckoning / animation between updates
...
- Team flying / buddy codes (encrypted team codes, buddy starring/highlighting, friend colouring)
...
- Automatic position-sharing on takeoff / auto flight claim after landing *(XCTrack, WeGlide LiveConnect)*
...
*(Mostly from per-system additional features; primary in the powered-EFIS and high-end avionics systems.)*
...
- Cloud platform / ecosystem hub (LX Cloud, LXNAV Connect, SeeYou Cloud, WeGlide) *(Navia, LXNAV, SeeYou Navigator, WeGlide Copilot)*
