...
- [x] **core-runtime:** the shared runtime used by the server and Tauri: bounded FIFO input queue, effect execution, snapshot-first state delivery, visible slow-client drops, worker failure handling, and runtime measurements (see [design/runtime.md](design/runtime.md)). _(needs: core-app)_
