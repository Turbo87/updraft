...
- [x] **installed-data-library-view**: show imported airspace and waypoint files in grouped lists with counts, disabled states, and errors. Import and removal remain on the existing source pages.
