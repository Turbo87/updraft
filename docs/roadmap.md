...
- [x] **flight-data-fields** — show ten fixed Flight View infoboxes for altitude, AGL, ground speed, TAS, bank, vario, netto, wind speed, wind direction, and average vario. The dock respects safe areas in portrait and landscape. _(needs: route-shell, frontend-protocol, units-settings)_
