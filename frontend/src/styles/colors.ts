...
type OklchColor = `oklch(${number} ${number} ${number})`;

/** Defines the authoritative OKLCH color palette for generated frontend artifacts. */
export const COLORS = {
  ...
  'olive-50': 'oklch(0.988 0.003 106.5)',
  'olive-100': 'oklch(0.966 0.005 106.5)',
  'olive-200': 'oklch(0.93 0.007 106.5)',
  'olive-300': 'oklch(0.88 0.011 106.6)',
  'olive-400': 'oklch(0.737 0.021 106.9)',
  'olive-500': 'oklch(0.58 0.031 107.3)',
  'olive-600': 'oklch(0.466 0.025 107.3)',
  'olive-700': 'oklch(0.394 0.023 107.4)',
  'olive-800': 'oklch(0.286 0.016 107.4)',
  'olive-900': 'oklch(0.228 0.013 107.4)',
  'olive-950': 'oklch(0.153 0.006 107.1)',
  'mist-50': 'oklch(0.987 0.002 197.1)',
  'mist-100': 'oklch(0.963 0.002 197.1)',
  'mist-200': 'oklch(0.925 0.005 214.3)',
  'mist-300': 'oklch(0.872 0.007 219.6)',
  'mist-400': 'oklch(0.723 0.014 214.4)',
  'mist-500': 'oklch(0.56 0.021 213.5)',
  'mist-600': 'oklch(0.45 0.017 213.2)',
  'mist-700': 'oklch(0.378 0.015 216)',
  'mist-800': 'oklch(0.275 0.011 216.9)',
  'mist-900': 'oklch(0.218 0.008 223.9)',
  'mist-950': 'oklch(0.148 0.004 228.8)',
  'taupe-50': 'oklch(0.986 0.002 67.8)',
  'taupe-100': 'oklch(0.96 0.002 17.2)',
  'taupe-200': 'oklch(0.922 0.005 34.3)',
  'taupe-300': 'oklch(0.868 0.007 39.5)',
  'taupe-400': 'oklch(0.714 0.014 41.2)',
  'taupe-500': 'oklch(0.547 0.021 43.1)',
  'taupe-600': 'oklch(0.438 0.017 39.3)',
  'taupe-700': 'oklch(0.367 0.016 35.7)',
  'taupe-800': 'oklch(0.268 0.011 36.5)',
  'taupe-900': 'oklch(0.214 0.009 43.1)',
  'taupe-950': 'oklch(0.147 0.004 49.3)',
  black: 'oklch(0 0 0)',
  white: 'oklch(1 0 0)',
