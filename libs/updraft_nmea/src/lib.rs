...
pub use sentences::{
    ...
    PflalConfiguration, PflalContent, PflalOwnId, PflalPower, Pflam, PflamIdentity, Pflau,
    PflauAlarmType, PflauGpsStatus, Pflav, Pgrmz, PgrmzFixDimension, Plxv0, Plxv0Direction, Plxvc,
    PlxvcMessageType, Plxvf, Plxvs, PlxvsMode, Plxvtarg, PositioningMode, Pov, PovDatum, Rmc,
    RmcStatus,
};
